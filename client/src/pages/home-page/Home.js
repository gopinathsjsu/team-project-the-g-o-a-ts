    ...
    <div className="home-container">
        ...
        <div className="home-pricing1">
          ...
          <div className="home-container06">
            ...
            <div className="home-pricing-card1">
              ...
              <button className="home-button1 button">Try the Premium plan</button>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="home-banner">
        <div className="home-banner1">
          <h1 className="home-banner-heading heading2">Exclusive Movie Experiences</h1>
          <span className="home-banner-sub-heading">
            Discover a world of immersive cinema with our Movie Theater Club application.
          </span>
      ...
      <div className="home-footer">
        <footer className="home-footer1">
          ...
          <div className="home-container33">
            <span className="home-text61">All Rights Reserved.</span>
